        ...
        <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-14 min-h-[260px] sm:min-h-[280px] md:min-h-[300px]">
          ...
          <div className="py-6 md:py-8">
            ...
            <div className="mt-6">
              <Link
                href={data.cta.href}
                className="group inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-primary transition focus:outline-none focus-visible:ring-4 hover:bg-primary-dark hover:text-white duration-300 hover:scale-[1.05] focus-visible:ring-white/40"
              >
                {data.cta.label}
