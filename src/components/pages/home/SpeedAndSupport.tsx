      ...
      <div>
        ...
        <div className="mt-6 space-y-4">
          {speedAndSupportData.features.map((feature) => (
            <div
              key={feature.id}
              className="flex items-center  cursor-pointer  bg-card-background space-x-4 border border-border-light-gray hover:scale-[1.02]  duration-300 transition  p-4 rounded-xl relative"
            >
