...
const defaultData: VpsData = {
  ...
  ctas: [
    ...
    { label: "See specs", href: "#vps-pricing", variant: "ghost" }
  ],
  highlights: [
    {
  ...
  return (
    <section aria-label="VPS showcase">
      ...
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-base sm:text-lg text-text/70">{d.subheading}</p>
      ...
      <div className="mt-12 grid items-end gap-10 lg:grid-cols-2 h-full">
        ...
        <div className="relative  mb-6  flex-col flex   justify-end">
          ...
          {/* Small overlay image */}
          <div className="absolute -left-2 md:-left-4 -bottom-6 w-2/3 sm:w-1/2">
          ...
          {/* Decorative line */}
          <div className="pointer-events-none absolute right-0 md:-right-6 -top-6 h-20 w-20 rounded-full ring-4 ring-primary/40" />
        </div>
      </div>
    </section>
  );
