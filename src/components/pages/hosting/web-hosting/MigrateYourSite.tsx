...
const MigrateYourSite = () => {
  return (
    <section className="flex flex-col lg:flex-row bg-card-background rounded-2xl border-2 border-border-light-gray shadow-xl w-full p-8 sm:p-10 gap-6 sm:gap-8 md:gap-10 lg:gap-20 items-center  duration-500 transition ">
      ...
      <section className="flex-1 text-center lg:text-left order-1 lg:order-2">
        <h2 className="text-[26px] sm:text-2xl md:text-3xl font-bold text-text mb-3 sm:mb-4 leading-snug">
          {WebHostingData.migrateYourSiteSection.title}
        </h2>
        <p className="text-[15px] sm:text-base text-description-text mb-4 sm:mb-6 md:mb-8 max-w-xl mx-auto lg:mx-0">
