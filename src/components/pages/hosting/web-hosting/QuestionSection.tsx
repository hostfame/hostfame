...
const QuestionSection = () => {
  return (
    <section className='flex flex-col-reverse lg:flex-row items-center bg-gradient-to-r from-blue-950 to-blue-800 rounded-2xl shadow-2xl px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8 md:py-8 w-full min-h-[250px] sm:min-h-[200px] gap-6 sm:gap-8 lg:gap-0'>
      <section className='flex-1 flex flex-col justify-center items-start lg:pr-10 text-center lg:text-left'>
        ...
        <Link href={WebHostingData.questionSection.buttonLink} className='bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg shadow-lg transition-colors duration-200 text-sm sm:text-base md:text-base w-full sm:w-auto inline-block text-center cursor-pointer font-bold'>
          <button>
