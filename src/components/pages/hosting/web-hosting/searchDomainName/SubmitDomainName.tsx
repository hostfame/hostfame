...
const SubmitDomainName = () => {
  ...
  return (
    <form
      className="flex flex-row border border-border-light-gray rounded-xl w-full mx-auto md:mx-0"
    ...
    >
      <input
        ...
        className="flex-1 px-2 py-3 sm:px-4 sm:py-4 bg-card-background text-lg lg:text-xl outline-none border-none rounded-l-xl font-medium"
      />
      <button
        type="submit"
