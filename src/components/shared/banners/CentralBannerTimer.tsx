...
export type CentralBannerTimerProps = {
  className?: string;
  boxClassName?: string;
...
export const CentralBannerTimer: React.FC<CentralBannerTimerProps> = ({
  className = "",
  boxClassName = "",
  timerClassName = "",
  unitClassName = "",
  ...
  const { days, hours, minutes, seconds } = useCentralCountdown();
