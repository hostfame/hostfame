...
export default function DomainBanner() {
  ...
  return (
    <section className="banner-bg flex flex-col -mt-[1px] w-full text-white bg-no-repeat overflow-hidden min-h-screen relative">
      {/* Layered teal header */}
      ...
      <div className="flex-1 flex items-center">
        <SectionWrapper className="relative w-full py-8 md:py-12">
              ...
              <div className="rounded-2xl bg-white p-5 shadow-2xl ring-1 ring-gray-100">
                ...
                <div className="mt-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="self-center px-1 text-xs font-medium text-gray-500">
                      & 270+ More
                    </span>
                  </div>
                </div>
