...
const data: VpsData = {
  ...
  features: [
    {
      id: "nvme",
      icon: <LuHardDrive className="h-6 w-6" aria-hidden="true" />,
    ...
    {
      id: "root",
      icon: <LuTerminal className="h-6 w-6" aria-hidden="true" />,
    ...
    {
      id: "scalable",
      icon: <TbCpu className="h-6 w-6" aria-hidden="true" />,
    ...
    {
      id: "security",
      icon: <TbShieldCheck className="h-6 w-6" aria-hidden="true" />,
    ...
    {
      id: "os",
      icon: <LuCog className="h-6 w-6" aria-hidden="true" />,
      title: "OS Freedom",
      description:
    ...
    {
      id: "control",
      icon: <TbServerBolt className="h-6 w-6" aria-hidden="true" />,
      title: "Admin Control",
      description:
  ...
  return (
    <section className="relative mx-auto text-text">
      <div className="relative">
        {/* Eyebrow */}
        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-border-light-gray bg-primary-light text-white px-3 py-1 text-xs tracking-wide ">
          <HiOutlineBolt className="h-3.5 w-3.5" aria-hidden="true" />
          <span>{data.eyebrow}</span>
        </div>

        {/* Heading + copy */}
        <div className="mb-8 flex flex-col gap-4 md:max-w-3xl">
          <h2 className="text-3xl font-semibold leading-tight md:text-4xl text-text">
            {data.heading}
          </h2>
          <p className="text-base leading-relaxed text-description-text">
            {data.description}
          </p>
        </div>
        ...
        {/* Static progress bar */}
        {/* <div className="mb-10">
          <div className="mb-2 flex items-center justify-between text-xs text-description-text">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {data.features.map((f) => (
            <article
              key={f.id}
              className="group rounded-2xl border border-border-light-gray bg-card-background p-5 transition-transform hover:-translate-y-0.5 hover:bg-gradient-to-t from-primary to-primary-light"
            >
              <div className="mb-4 inline-flex items-center justify-center rounded-lg bg-white-background p-2 text-toggle shadow-sm ring-1 ring-inset ring-border-light-gray transition-all group-hover:shadow-lg">
                {f.icon}
              </div>
              <h3 className="mb-2 text-lg font-medium text-text transition-colors group-hover:text-white">
                {f.title}
              </h3>
        ...
        {/* Subtle divider */}
        <div className="mt-12 h-px w-full bg-border-light-gray" />
      </div>
    </section>
  );
}
