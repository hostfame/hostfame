                        ...
                        >
                          {item.subItems.map((subItem) => (
                            <Link
                              key={subItem.label}
                              href={subItem.href}
                              className={`flex items-start p-3 rounded-lg hover:bg-blue-50 transition-all duration-200 ease-in-out transform hover:scale-102 ${
                            ...
                            >
                              ...
                              <div>
                                ...
                                <div className="text-xs text-description-text mt-0.5">
                                  {subItem.description}
                                </div>
                              </div>
                            </Link>
