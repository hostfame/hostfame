...
export const DomainWhyChooseHostfameData = {
  ...
  cards : [
    ...
    },
    {
      ...
      desc: "We include free WHOIS privacy protection (where supported) to keep your data safe.",
      icon: FaLock,
    },
    {
      title: "Transparent Pricing",
      desc: "No hidden charges, no confusing upsells. Always know exactly what you’re paying.",
